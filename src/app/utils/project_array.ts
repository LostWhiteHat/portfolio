...
const projectList: Project[] = [
    {
        ...
        title: 'Tasker',
        description:
            'This is my first CPP project. I am going to learn the basics of the language and i am trying to save, read and delete specific data to or from a file.',
    ...
    },
    {
        ...
        description:
            'In this project i started learning Java with Gradle and Springboot.',
